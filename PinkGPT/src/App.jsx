  ...
  return (
    <>
      <div>
        ...
        <div className= 'fixed bg-pink-900 h-screen border-r-[5px] border-white-300 border-dashed w-[340px] flex'>
          <h1 className='pl-16 pt-1 font-black font-mono h-12 w-full  border-b-[5px] border-white-300 border-dashed text-white text-2xl'>New Chat</h1>
        
        </div>
        
        <div className='relative top-5 bottom-96'>
